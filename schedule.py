...
class Schedule:
    ...
    def create_schedule(self, times=[], events=[], conn=""):
        ...
        htmlArray = [test_calendar_body, "<form action='" + submit_url + "' method='POST'> <table><tr><th>Time</th><th>Mon</th><th>Tues</th><th>Wed</th><th>Thur</th><th>Fri</th><th>Sat</th><th>Sun</th>"]
        ...
        htmlArray.append("</tr></table> <input type='submit' value='"+submit_name+"'> </form>")
